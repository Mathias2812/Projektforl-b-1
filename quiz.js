...
const questions = [
    ...
    { question: "5 million plastic bottles are bought every minute?", answer: false, explanation: "It's 'only' 1 million plastic bottles that are bought every minute." },
    ...
    { question: "There will be more plastic in our oceans than fish by 2080?", answer: false, explanation: "There will be more plastic in the oceans by 2050 than fish, if we don't do anything about it." },
    ...
    { question: "If everyone switched to reusable bottles and carton water, we would be able to save enough energy to power New York City for an entire month?", answer: true, explanation: "Now imagine if everything became recycled/reusable instead of 1 time uses, how much energy we would save in the long term?" },
];
